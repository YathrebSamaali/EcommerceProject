    ...
    <div class="row isotope-grid">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo '<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ' . strtolower($row['categorie']) . '">';
                echo '<div class="block2">';
                echo '<div class="block2-pic hov-img0">';
                echo '<img src="' . $row['image'] . '" alt="IMG-PRODUCT">';
                echo '<a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">Quick View</a>';
                echo '</div>';
                echo '<div class="block2-txt flex-w flex-t p-t-14">';
                echo '<div class="block2-txt-child1 flex-col-l ">';
                echo '<a href="product-detail.php?id=' . $row['id'] . '" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">' . $row['nom'] . '</a>';
                echo '<p class="stext-105 cl6">' . $row['description'] . '</p>'; // Description du produit
                echo '<span class="stext-105 cl3">' . $row['prix'] . '$</span>'; // Prix du produit
                echo '</div>';
